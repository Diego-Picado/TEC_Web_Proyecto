## Bibliografia:
### Color Palette:
- #### [Palette](https://coolors.co/104547-4b5358-727072-5a0224-d2d6ef)


### Selector Universal
- #### [Selector1](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/Universal_selectors)
- #### [Selector1](https://www-w3schools-com.translate.goog/cssref/sel_all.php?_x_tr_sl=en&_x_tr_tl=es&_x_tr_hl=es&_x_tr_pto=tc)

### Favicon:
- #### [Favicon](https://www-w3schools-com.translate.goog/html/html_favicon.asp?_x_tr_sl=en&_x_tr_tl=es&_x_tr_hl=es&_x_tr_pto=tc)

### Github Pages:
  - #### [Github pages](https://www.w3schools.com/git/git_github_pages.asp)

  - #### [Github pages2](https://github.com/sphinx-doc/sphinx/issues/3382)

  - #### [Github pages3](https://docs.github.com/en/pages/getting-started-with-github-pages/creating-a-github-pages-site)

### NavBar:
  - #### [Navigation bar](https://www.w3schools.com/css/css_navbar.asp)

  - #### [Navigation bar2](https://stackoverflow.com/questions/70615219/making-a-navbar-go-to-the-correct-section)

  - #### [Navigation bar3](https://www.youtube.com/watch?v=e3phTzUvrsY)

### Footer:
- #### [Footer](https://lineadecodigo.com/html5/pie-de-pagina-en-html5/)

- #### [Footer2](https://www-w3schools-com.translate.goog/tags/tag_footer.asp?_x_tr_sl=en&_x_tr_tl=es&_x_tr_hl=es&_x_tr_pto=tc)
...
### Pseudo ::after
- #### [After1](https://developer.mozilla.org/es/docs/Web/CSS/Reference/Selectors/::after)
- #### [After2](https://www.w3schools.com/cssref/sel_after.php)

### Clamp
- #### [Clamp1](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Values/clamp)
- #### [Clamp2](https://www.w3schools.com/cssref/func_clamp.php)
- #### [Clamp3](https://web.dev/articles/min-max-clamp)
- #### [Clamp4](https://www.youtube.com/shorts/TTPCB_ydfRY)
- #### [Clamp4](https://www.youtube.com/watch?v=3zUw8gd3e80)
